...
class CheckoutController extends Controller
{
    ...
    public function add_customer(Request $request){
        ...
        $result = Customer::where('customer_email',$customer_email)->first();
        if($result){
            Session::put('message','Email đã tồn tại');
            return redirect()->back();
        }else{
            $customer_id = Customer::insert($data);
    ...
    public function view_order($orderId){
        $this->AuthLogin();
        $order_by_id = Order::join('customer','order.customer_id','=','customer.customer_id')
    ...
    public function manage_order(){
        ...
        $this->AuthLogin();
        $all_order = Order::join('customer','order.customer_id','=','customer.customer_id')
